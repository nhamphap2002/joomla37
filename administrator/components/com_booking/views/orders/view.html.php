 ...
 * @since  1.6
 */
class BookingViewOrders extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		BookingHelper::addSubmenu('orders');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_BOOKING_TITLE_ORDERS'), 'orders.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_booking&view=orders');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`start_date`' => JText::_('COM_BOOKING_ORDERS_START_DATE'),
			'a.`end_date`' => JText::_('COM_BOOKING_ORDERS_END_DATE'),
			'a.`number_room`' => JText::_('COM_BOOKING_ORDERS_NUMBER_ROOM'),
			'a.`number_persons`' => JText::_('COM_BOOKING_ORDERS_NUMBER_PERSONS'),
			'a.`number_children`' => JText::_('COM_BOOKING_ORDERS_NUMBER_CHILDREN'),
			'a.`order_note`' => JText::_('COM_BOOKING_ORDERS_ORDER_NOTE'),
			'a.`name_customer`' => JText::_('COM_BOOKING_ORDERS_NAME_CUSTOMER'),
			'a.`phome`' => JText::_('COM_BOOKING_ORDERS_PHOME'),
			'a.`email`' => JText::_('COM_BOOKING_ORDERS_EMAIL'),
		);
	}
