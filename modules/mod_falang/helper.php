...
abstract class modFaLangHelper
{
                    ...
                    //default case
	                 ...
	                 //fix problem on mod_login (same position before falang module
	                    ...
	                    // need to load the path of the ItemId
                         ...
                         $uri->setVar('lang',$language->sef);
	                     //set language link
                         $language-> link = modFaLangHelper::getLinkWithoutSefEnabled($language,$lang,$default_lang);
	 ...
	 * @since version 2.8.4
	 */
    public static function getLinkWithoutSefEnabled($language,$lang,$default_lang)
    {
